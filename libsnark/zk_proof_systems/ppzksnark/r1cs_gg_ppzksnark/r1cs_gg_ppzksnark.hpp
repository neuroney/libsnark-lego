...
public:
    ...
    static auto aux_kg(auto g1_generator, auto G2_gen, auto t, auto alpha, auto beta, auto gamma, auto delta, const auto r1cs, libff::G1_vector<ppT> &gamma_ABC_g1_values);
